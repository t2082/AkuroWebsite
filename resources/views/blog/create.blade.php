                ...
                <div class="flex flex-wrap -mx-2">
                    <div class="w-full px-2">
                        <div class="bg-white p-5 rounded shadow-lg">
                            ...
                            <form action="{{ route('blog.store') }}" method="POST" onsubmit="submitForm()">
                                @csrf
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="description" name="description" placeholder="Brief description"></textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="block text-gray-700 text-sm font-bold mb-2" for="content">
                                        Content
                                    </label>
                                    <div id="editor" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline h-96"></div>
                                </div>
